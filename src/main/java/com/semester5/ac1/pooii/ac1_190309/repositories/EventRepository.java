...
public interface EventRepository extends JpaRepository <Event,Long>{
    ...
    public Page<Event> findEventPageable(Pageable pageRequest, String name, String description);
    ...
    public Page<Event> findEventPageable_Date(Pageable pageRequest, String name, String description, LocalDate startDate);
}
